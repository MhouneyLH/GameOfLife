...
public:
    ...
    Q_INVOKABLE void loadPattern();
    Q_INVOKABLE void clear();

private:
    static constexpr unsigned int width = 256U;
    static constexpr unsigned int height = 256U;
    ...
    static QPoint cellCoordinateFromIndex(const int cellIndex);
